...
list2 = guest.owned_lists.create({user_id: 1, title: "Lunch Meal Prep Grocery list"})
...
list2column1.gitems.create('quinoa', ord: 1)
list2column1.gitems.create('celery', ord: 2)
list2column1.gitems.create('carrots', ord: 3)
list2column1.gitems.create('peanut butter', ord: 4)
...
list2column3.gitems.create('steak', ord: 1)
list2column3.gitems.create('sweet potatoes', ord: 2)

list2column4.gitems.create('green pepper', ord: 1)
list2column4.gitems.create('yogurt', ord: 2)
list2column4.gitems.create('onion', ord: 3)

...
list2 = guest.owned_lists.create({user_id: 1, title: "Weekly Grocery list"})
...
list3 = guest.owned_lists.create({user_id: 1, title: "Weekly Grocery list"})
...
list3.columns.first.new(title: "test", column_id: list3.columns.first.id, expired: false )
